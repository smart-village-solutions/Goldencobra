...
Goldencobra::Permission.create(:sorter_id => 1, :role_id => admin.id, :action => "manage", :subject_class => ":all" )
Goldencobra::Permission.create(:sorter_id => 1, :role_id => guest.id, :action => "read", :subject_class => "Goldencobra::Article" )
Goldencobra::Permission.create(:sorter_id => 1, :role_id => guest.id, :action => "show", :subject_class => "User", :subject_id => "user.id" )
Goldencobra::Permission.create(:sorter_id => 1, :role_id => guest.id, :action => "update", :subject_class => "User", :subject_id => "user.id" )
Goldencobra::Permission.create(:sorter_id => 1, :role_id => guest.id, :action => "destroy", :subject_class => "User", :subject_id => "user.id" )
