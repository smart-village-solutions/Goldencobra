      ...
      React.createElement("li", {className: "listItem", id: "overview_item_" + id},
        React.createElement("div", {className: "item"},
          ...
          React.createElement("div", {className: "title"},
            React.createElement("a", {href: "/admin/articles?q%5Bparent_ids_in%5D=" + id, title: "Pfad anzeigen"}, this.props.title)
          ),
          React.createElement("div", {className: "options"},
            React.createElement("a", {href: "/admin/articles/" + id + "/edit", className: "edit_link", title: "Bearbeiten"}, "bearbeiten"),
            React.createElement("a", {href: "/admin/articles/new?parent=" + id, className: "new_link", title: "Neu"}, "Neu")
          ),
          showChildren
        )
      )
