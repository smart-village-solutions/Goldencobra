ActiveAdmin.register Goldencobra::Articletype, :as => "Articletype" do
  menu :priority => 8, :parent => I18n.t('active_admin.articles.parent'), :label => I18n.t('active_admin.articletypes.as'), :if => proc{can?(:update, Goldencobra::Article)}
  ...
  form :html => { :enctype => "multipart/form-data" }  do |f|
    ...
    f.inputs I18n.t('active_admin.articletypes.article_fields'), :class => "foldable closed inputs" do
