...
ActiveRecord::Schema.define(version: 20180308124302) do
  ...
  create_table "goldencobra_article_urls", force: :cascade do |t|
    t.integer  "article_id", limit: 4
  ...
  create_table "goldencobra_articles", force: :cascade do |t|
    ...
    t.string   "display_index_types",                 limit: 255,   default: "all"
    ...
    t.string   "display_index_articletypes",          limit: 255,   default: "all"
    t.string   "index_of_articles_descendents_depth", limit: 255,   default: "1"
    t.integer  "ancestry_depth",                      limit: 4,     default: 0
    t.string   "metatag_title_tag",                   limit: 255
    t.string   "metatag_meta_description",            limit: 255
    t.string   "metatag_open_graph_title",            limit: 255
    t.string   "metatag_open_graph_description",      limit: 255
    t.string   "metatag_open_graph_type",             limit: 255,   default: "website"
